...
namespace Game
{
    public class CSharpMessageSerializer : MessageSerializer
    {
        ...
        //        GD.Print("serialized enum: " + header + " as byte: " + ((byte)header));
